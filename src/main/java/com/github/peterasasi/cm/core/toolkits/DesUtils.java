...
public class DesUtils {
    ...
    public final static String ALG = "DES/CBC/pkcs5padding";

    /**
     * 默认
     */
    public final static String DEFAULT_IV = "12345678";
    ...
    public static String encrypt(byte[] dataBytes, String key, String iv) throws CryptException {
        ...
        SecretKeySpec secretKeySpec = new SecretKeySpec(enCodeFormat, "DES");
